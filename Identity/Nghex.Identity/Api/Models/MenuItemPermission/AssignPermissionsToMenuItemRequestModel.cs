...
{
    /// <summary>
    /// Request model for assigning permissions to a menu item (use-case: (menuKey, list&lt;permissionIds&gt;))
    /// </summary>
    public class AssignPermissionsToMenuItemRequestModel : BaseRequestModel
    {
        /// <summary>
        /// Menu key
        /// </summary>
